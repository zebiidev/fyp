...
import Signup from "./pages/Signup"; // eager load for instant access

import ForgotPassword from "./pages/ForgotPassword.jsx";
import ResetPassword from "./pages/ResetPassword.jsx";

// Lazy‑load other pages with prefetch hint
const Home = React.lazy(
  () => import(/* webpackPrefetch: true */ "./pages/Home"),
);
const PendingApproval = React.lazy(() => import("./pages/PendingApproval"));
const PassengerDashboard = React.lazy(
  () => import("./pages/passenger/Dashboard"),
);
...
const CompleteProfile = React.lazy(
  () => import("./pages/passenger/CompleteProfile"),
);
...
const VehicleManagement = React.lazy(
  () => import("./pages/rider/VehicleManagement"),
);
const EditVehicle = React.lazy(() => import("./pages/rider/EditVehicle"));
const CompleteRiderProfile = React.lazy(
  () => import("./pages/rider/CompleteRiderProfile"),
);
const VehicleCompletion = React.lazy(
  () => import("./pages/rider/VehicleCompletion"),
);
...
const VerificationPortal = React.lazy(
  () => import("./pages/admin/VerificationPortal"),
);
const SystemAnalytics = React.lazy(
  () => import("./pages/admin/SystemAnalytics"),
);
...
const RegistrationDirectory = React.lazy(
  () => import("./pages/admin/RegistrationDirectory"),
);
...
function App() {
  ...
  return (
    <>
      ...
      <Router>
        <React.Suspense
          fallback={<Loader fullPage message="Loading page..." />}
        >
          <Routes>
